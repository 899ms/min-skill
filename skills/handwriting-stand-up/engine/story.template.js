...
window.STORY = (() => {
  const CAST = {
    left: {
      banner: 'Knight', face: 'calm',
      tunic: '#c8694a', tunicDk: '#8e3f2a', hoseA: '#efe6d2', hoseB: '#2f2b33', glove: '#2d4f9a',
      hair: 'curly', hairC: '#3a2a22', glasses: true, emblem: 'star', book: '规矩',
    },
    right: {
      banner: 'Rival', face: 'grin',
      tunic: '#2f6b63', tunicDk: '#1c4640', hoseA: '#efe6d2', hoseB: '#b8402c', glove: '#c4402c',
      hair: 'short', hairC: '#8b6a4b', eyeR: 2.05, emblem: 'cross', gloveLabel: 'MAX',
      brows: 'M66.5 36.6 Q70 33.8 74 35.2 M78.6 34.8 Q81.4 33.2 84 35',
    },
  };

  const LINES = {
    prologue: ['序章 · Prologus', '很久很久以前，在一页纸上。'],
    arrive: '字刚站稳，就来了两位骑士。',
    left: ['左边这位，蓝手套骑士。', '随身带着一本《规矩》'],
    right: ['右边这位，红手套骑士。', '出拳之前，先喊口号'],
    claim: '两人异口同声：「这一页，归我。」',
    referee: ['裁判，是一只蜗牛。', '中世纪手抄本的老规矩：页边总少不了一只蜗牛。'],
    r1: ['红手套先出手——', '一记「全力以赴」重拳。', '蓝手套只是低了一下头。', '拳风太大，把第一个字吹得晃了三晃。'],
    r2: ['红手套换了打法：连环快拳。', '蓝手套翻开随身的小书——《规矩》。', '每一拳，都被原则挡了回去。'],
    tags: ['快！', '更快！', '再快！', '看这边！', '全力以赴！', '稍等！', '再来！', '下一拳！', '别跑！', '最后一拳！'],
    r3: [['蓝手套终于出手。', '他向身后最后一个字，借了一点光。'], '只出了一拳。', '一拳，把对手打回了纸上。'],
    count: ['蜗牛开始读秒——', '它数得……非常……慢。'],
    countSigns: ['一', '二', '三'],
    help: '还没数到三，蓝手套先把对手扶了起来。',
    ask: '所以，谁赢了？',
    end: '答案，一直写在纸上。',
  };

  return {
    meta: { title: 'Stand Up', tagline: '一行字，站起来之后的故事', hero: ['Stand', 'Up'], heroSub: '站起来了。', docTitle: 'Stand Up' },
